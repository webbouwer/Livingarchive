...
add_action( 'init',  function() {
    ...
    //Array ( [p] => tags [tags] => zee,land )

    // /category/artikelen,researchteam ! overwriting category
    //add_rewrite_rule( 'category/([^/]*)[/]?$', 'index.php?cats=$matches[1]', 'top' );

    // category/artikelen,researchteam/tags/zee,land
    add_rewrite_rule('^category/([^/]*)/tags/([^/]*)/?','index.php?cats=$matches[1]&tags=$matches[2]','top');
